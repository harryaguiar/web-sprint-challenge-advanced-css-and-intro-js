...
Accessibility gives access to your website or any program to those who experience disbilities.

2. Talk about 3 different things you can do to ensure your website is accessible. 
Use rems instead of pixels, use percentage for resizing, and use @media to make your site accessible to any device. Also, use correct tags throught out your html

3. How would you explain the concept of a variable to someone new to programming?
Variable hold any type of data or value. it can also be changed anytime.

4. What is the purpose of using functions in code?
It gives you the opportunity to use the same function over an over again through out your program.
